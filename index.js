...
ux.addEventListener('click', () => {
    window.location.href = "html/UX.html";
})

branding.addEventListener('click', () => {
    window.location.href = "html/branding.html";
})
...
ilustration.addEventListener('click', () => {
    window.location.href = "html/Ilustration.html";
})

editorial.addEventListener('click', () => {
    window.location.href = "html/editorial.html";
})
